...
namespace CRCC.BaseClientSystem.IRepositories
{
    public interface BaseIRespositiories<TEntity> where TEntity : class
    {  /// <summary>
       /// SqlsugarClient实体
       /// </summary>
        ...
        Task<int> AddBulkCopy(List<TEntity> listEntity);
        /// <summary>
        /// 根据id 删除某一实体
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <returns></returns>
        Task<bool> DeleteByWhere(Expression<Func<TEntity, bool>> expression);
        /// <summary>
        /// 更新model
        /// </summary>
        /// <param name="model"></param>
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        Task<int> UpdateList(List<TEntity> listEntity);
        /// <summary>
        /// 更新model
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        Task<bool> UpdateByWhere(TEntity entity, Action<TEntity> action);
        /// <summary>
        /// 根据model，更新，带where条件
        /// </summary>
